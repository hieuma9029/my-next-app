...
export default function FirstStart() {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/images/banners/home-three-img.jpg')",
      }}
    >
      <div className="absolute inset-0 bg-white opacity-70"></div>
      <div className="text-left flex flex-col w-1/2 relative z-10">
        <h1 className="text-5xl font-bold mb-4 text-black">DIAMOND SOFTWARE</h1>
      ...
      <div className="relative w-1/2 rounded-bl-clip z-10">
        <Image
          src="/images/banners/home-three-img.jpg"
          alt="Sample"
          width={600}
          height={400}
