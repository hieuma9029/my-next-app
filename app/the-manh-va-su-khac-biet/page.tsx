...
export default function AboutUsPage() {
  return (
    <div className="min-h-screen flex flex-col relative">
      <Header />
      <main className="flex items-center text-black justify-center bg-gray-100 pt-36 pb-54 px-100">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-3xl">
          ...
          <p className="mb-4 text-justify">
            Nơi hội tụ của các chuyên gia dày dạn trong lĩnh vực công nghệ thông tin, quản trị doanh nghiệp, ERP, kế toán,… sẽ đem lại sản phẩm:
          </p>
